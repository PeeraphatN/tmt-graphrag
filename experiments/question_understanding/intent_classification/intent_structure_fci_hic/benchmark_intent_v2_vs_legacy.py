...
- Topics centroid head (manufacturer/substance/nlem/hierarchy/formula/general)
...
DATASET_PATH = EXPERIMENT_DIR / "data" / "source_snapshots" / "legacy_intent_dataset.json"
