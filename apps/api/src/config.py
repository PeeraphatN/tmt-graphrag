...
# Retrieval/list execution controls
LIST_MAX_K_CAP = int(os.getenv("LIST_MAX_K_CAP", "200"))
RETRIEVAL_EVAL_MODE = _as_bool(os.getenv("RETRIEVAL_EVAL_MODE"), default=False)
NLEM_QA_ENABLED = _as_bool(os.getenv("NLEM_QA_ENABLED"), default=False)
